...
title = "RYAAY"
plt.text(datetime_objs[300], plt.ylim()[1] * 0.88, title, fontsize=56, ha='left', va='top', fontname='Times New Roman')
plt.title('RYAAY Close Price Over Time', fontsize=16, fontfamily='serif')
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
plt.legend(loc='upper right', prop={'family': 'serif', 'size': 11})
plt.xlabel('Date', fontsize=15, fontname='Times New Roman')
plt.ylabel('Close Price (US Dollars)', fontsize=15, fontname='Times New Roman')
