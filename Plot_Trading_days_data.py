...
title = "RYAAY"
plt.text(datetime_objs[300], plt.ylim()[1] * 0.9, title, fontsize=58, ha='left', va='top', fontname='Times New Roman')
plt.title('RYAAY Close Price Over Time', fontsize=14, fontfamily='serif')
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
