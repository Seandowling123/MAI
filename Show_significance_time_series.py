...
plt.title('Statistical Significance of Lag-1 Positive Sentiment on Returns Over Time', fontsize=14, fontfamily='serif')
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
plt.legend(fontsize=11, loc='upper left', prop={'family': 'serif', 'size': 11})
...
plt.title('Statistical Significance of Lag-1 Negative Sentiment on Returns Over Time', fontsize=14, fontfamily='serif')
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
plt.legend(fontsize=11, loc='upper left', prop={'family': 'serif', 'size': 11})
plt.xlabel('Date', fontsize=11, fontname='Times New Roman')
plt.ylabel('Statistical Significance Level', fontsize=11, fontname='Times New Roman')
